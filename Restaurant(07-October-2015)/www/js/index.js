var app = (function()
{
	...
	//	if (!mNearestBeacon) { return; }
        ...
        if(mNearestBeacon.uuid == 'b9407f30-f5f8-466e-aff9-25556b57fe6d' && mNearestBeacon.major == '19787' && mNearestBeacon.minor == '59065' && myBeaNoti != 1){
            ...
            var element1 = '<div class="card balanced-bg padding"><i style="color: white;font-size: 24px; padding: 5px 10px 5px 10px;" class="icon ion-close-circled right" onclick="closeBanner()"></i><a class="item clear-bg item-bg-image" ui-sref="app.lists"><h2>Drinks</h2><img src="img/drinks.jpg"></a></div>' + '<div style="height:50px; width:100%;"></div><div class="card energized-bg" style="padding:10px;"><p>UUIDUUID: ' + mNearestBeacon.uuid + '</p>' +	'<p>Major: ' + mNearestBeacon.major + '</p><p>Minor: ' + mNearestBeacon.minor + '</p><p>Proximity: ' + mNearestBeacon.proximity + '</p><p>Distance: ' + mNearestBeacon.accuracy + '</p><p>RSSI: ' + mNearestBeacon.rssi +'</p>';
            var element2 = '<div class="card balanced-bg padding"><i style="color: white;font-size: 24px; padding: 5px 10px 5px 10px;" class="icon ion-close-circled right" onclick="closeBanner()"></i><a class="item clear-bg item-bg-image" ui-sref="app.lists"><h2>Special Pizza</h2><img src="img/pizza.jpg"></a></div>' + '<div style="height:50px; width:100%;"></div><div class="card energized-bg" style="padding:10px;"><p>UUIDUUID: ' + mNearestBeacon.uuid + '</p>' +	'<p>Major: ' + mNearestBeacon.major + '</p><p>Minor: ' + mNearestBeacon.minor + '</p><p>Proximity: ' + mNearestBeacon.proximity + '</p><p>Distance: ' + mNearestBeacon.accuracy + '</p><p>RSSI: ' + mNearestBeacon.rssi +'</p>';
            var element3 = '<div class="card balanced-bg padding"><i style="color: white;font-size: 24px; padding: 5px 10px 5px 10px;" class="icon ion-close-circled right" onclick="closeBanner()"></i><a class="item clear-bg item-bg-image" ui-sref="app.lists"><h2>Punjabi Thali</h2><img src="img/lunch.jpg"></a></div>' + '<div style="height:50px; width:100%;"></div><div class="card energized-bg" style="padding:10px;"><p>UUIDUUID: ' + mNearestBeacon.uuid + '</p>' +	'<p>Major: ' + mNearestBeacon.major + '</p><p>Minor: ' + mNearestBeacon.minor + '</p><p>Proximity: ' + mNearestBeacon.proximity + '</p><p>Distance: ' + mNearestBeacon.accuracy + '</p><p>RSSI: ' + mNearestBeacon.rssi +'</p>';
            var element4 = '<div class="card balanced-bg padding"><i style="color: white;font-size: 24px; padding: 5px 10px 5px 10px;" class="icon ion-close-circled right" onclick="closeBanner()"></i><a class="item clear-bg item-bg-image" ui-sref="app.lists"><h2>Special Thali</h2><img src="img/breakfast.jpg"></a></div>' + '<div style="height:50px; width:100%;"></div><div class="card energized-bg" style="padding:10px;"><p>UUIDUUID: ' + mNearestBeacon.uuid + '</p>' +	'<p>Major: ' + mNearestBeacon.major + '</p><p>Minor: ' + mNearestBeacon.minor + '</p><p>Proximity: ' + mNearestBeacon.proximity + '</p><p>Distance: ' + mNearestBeacon.accuracy + '</p><p>RSSI: ' + mNearestBeacon.rssi +'</p>';
            var element5 = '<div class="card balanced-bg padding"><i style="color: white;font-size: 24px; padding: 5px 10px 5px 10px;" class="icon ion-close-circled right" onclick="closeBanner()"></i><a class="item clear-bg item-bg-image" ui-sref="app.lists"><h2>French Fries</h2><img src="img/dinner.jpg"></a></div>' + '<div style="height:50px; width:100%;"></div><div class="card energized-bg" style="padding:10px;"><p>UUIDUUID: ' + mNearestBeacon.uuid + '</p>' +	'<p>Major: ' + mNearestBeacon.major + '</p><p>Minor: ' + mNearestBeacon.minor + '</p><p>Proximity: ' + mNearestBeacon.proximity + '</p><p>Distance: ' + mNearestBeacon.accuracy + '</p><p>RSSI: ' + mNearestBeacon.rssi +'</p>';
